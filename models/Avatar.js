...
async function generateAvatarFromData2(avatarData, user_id) {
    ...
    */
    ...
    var jimp20 = (await Jimp.read(bgSrc))
    var jimp19 = (await Jimp.read(overlaySrc))
    var jimp18 = (await Jimp.read(hairBackSrc))
    var jimp17 = (await Jimp.read(hairAccessoriesSrc))
    var jimp16 = (await Jimp.read(baseSrc))
    var jimp15 = (await Jimp.read(eyebrowsSrc))
    var jimp13 = (await Jimp.read(makeupSrc))
    var jimp12 = (await Jimp.read(eyesSrc))
    var jimp11 = (await Jimp.read(mouthSrc))
    var jimp10 = (await Jimp.read(underSrc))
    var jimp9 = (await Jimp.read(topSrc))
    var jimp8 = (await Jimp.read(accessoriesSrc))
    var jimp7 = (await Jimp.read(outerwearSrc))
    var jimp6 = (await Jimp.read(hairSrc))
    var jimp5 = (await Jimp.read(hairSideSrc))
    var jimp4 = (await Jimp.read(hairFrontSrc))
    var jimp3 = (await Jimp.read(earsSrc))
    var jimp2 = (await Jimp.read(piercingsSrc))
    var jimp1 = (await Jimp.read(glassesSrc))
